...
alias ug="cd ~/.config; git pull origin main; sleep 0.37; ~/bin/SYNC; sleep 0.37; cd ~/.config; sleep 0.1; git add skhd yabai sketchybar linearmouse btop bin_scripts zsh_configs .gitignore && git commit -m \"\$(date +'%Y-%m-%d %H:%M:%S')\" && git push origin main" # ; sleep 0.37; git pull origin main"
